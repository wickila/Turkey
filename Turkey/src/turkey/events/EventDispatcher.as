...
package turkey.events
{
    ...
    public class EventDispatcher
    {
        ...
        public function dispatchEvent(event:TurkeyEvent):void
        {
        ...
        internal function invokeEvent(event:TurkeyEvent):Boolean
        {
        ...
        internal function bubbleEvent(event:TurkeyEvent):void
        {
        ...
        public function dispatchEventWith(type:String, bubbles:Boolean=false, data:Object=null):void
        {
            ...
            {
                var event:TurkeyEvent = TurkeyEvent.fromPool(type, bubbles, data);
                dispatchEvent(event);
            }
        }
